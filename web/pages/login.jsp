...
<body class="bootstrap-admin-without-padding"  style="background-image: url(<%=basePath%>static/plugins/datatables-1.10.8/images/back2.jpg);background-size:cover;">
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" action="login" method="post">
                <div class="form-group">
                    <label class="control-label" for="username">账&nbsp;号</label>
                    <input name="uname" type="text" class="form-control" id="username" placeholder="学号/管理员编码"/>
                ...
                <%--<div class="form-group">--%>
                    ...
                    <%--<select class="form-control" id="role">--%>
                        <%--<option name="student" value="1">学生</option>--%>
