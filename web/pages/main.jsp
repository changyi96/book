            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        <a class="navbar-brand" href="main.jsp"><strong>欢迎使用图书馆管理系统</strong></a>
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="login.jsp" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i> 欢迎您<%=((Book)session.getAttribute("vo").getBname())%>${vo.bname} <i class="caret"></i></a>
                                <ul class="dropdown-menu">
                                    <%--<li><a href="<%=basePath%>logout">退出</a></li>--%>
                                    <li><a href="<%=basePath%>/static/login.jsp">退出</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/book.jsp"><div class="text-muted bootstrap-admin-box-title">图书管理</div></a>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/book-type.jsp"><div class="text-muted bootstrap-admin-box-title">图书分类管理</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/borrow.jsp"><div class="text-muted bootstrap-admin-box-title">图书借阅</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>根据学号、图书编号借阅图书</li>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/return.jsp"><div class="text-muted bootstrap-admin-box-title">图书归还</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>根据学号、图书编号归还图书</li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/borrow-info.jsp"><div class="text-muted bootstrap-admin-box-title">借阅查询</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>展示所有学生的图书借阅信息</li>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/admin.jsp"><div class="text-muted bootstrap-admin-box-title">管理员管理</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/student.jsp"><div class="text-muted bootstrap-admin-box-title">学生管理</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<%=basePath%>/pages/admin/setting.jsp"><div class="text-muted bootstrap-admin-box-title">系统设置</div></a>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>设置最多借阅天数</li>
